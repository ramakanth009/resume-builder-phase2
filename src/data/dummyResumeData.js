...
const dummyResumeData = {
  ...
  summary: "Innovative Full Stack Developer with 3+ years of experience building scalable web applications with modern technologies. Passionate about clean code and user-centric design.",
  education: {
  ...
  work_experience: [
    {
      ...
      description: "Develop and maintain web applications using React and Node.js. Implement RESTful APIs and optimize database performance."
    },
    {
      position: "Frontend Developer Intern",
      company_name: "WebDev Agency",
      duration: "January 2021 - May 2021",
      description: "Assisted in developing responsive user interfaces using React and collaborated with the design team."
    }
  ],
  certifications: [
    {
