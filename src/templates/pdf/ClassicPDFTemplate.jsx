        ...
        <View style={styles.contactInfo}>
          {resumeData.header.email && (
            <Text style={styles.contactItem}>
              Email:{" "}
              <Link
                src={`mailto:${resumeData.header.email}`}
          ...
          {resumeData.header.github && (
            <Text style={styles.contactItem}>
              <Link
                src={formatUrl(resumeData.header.github)}
                style={styles.contactLink}
              >
                GitHub
              </Link>
          ...
          {resumeData.header.linkedin && (
            <Text style={styles.contactItem}>
              <Link
                src={formatUrl(resumeData.header.linkedin)}
                style={styles.contactLink}
              >
                LinkedIn
              </Link>
          ...
          {resumeData.header.portfolio && (
            <Text style={styles.contactItem}>
              <Link
                src={formatUrl(resumeData.header.portfolio)}
                style={styles.contactLink}
              >
                Portfolio
              </Link>
                ...
                <View style={styles.bulletList}>
                  ...
                  Array.isArray(experience.responsibilities)
                    ? experience.responsibilities
                        ...
                        .map((resp, idx) => <Bullet key={idx}>{resp}</Bullet>)
                    : experience.description
                    ? experience.description
                        .split("\n")
                        .filter((line) => line && line.trim() !== "")
                        .map((line, idx) => <Bullet key={idx}>{line}</Bullet>)
                    : null}
                </View>
              </View>
            ))}
