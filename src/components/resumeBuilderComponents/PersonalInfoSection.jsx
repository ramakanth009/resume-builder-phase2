...
const PersonalInfoSection = ({ resumeData, setResumeData, onRoleSelect, validationErrors = {}, clearValidationErrors }) => {
  const classes = useStyles();
  const [inputValue, setInputValue] = useState('');
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'header.phone') {
      ...
      return; // Don't proceed with normal handling for phone
    }
      ...
      <Box className={classes.fieldRow}>
        <Box className={classes.fieldContainer}>
          <TextField
            ...
            className={classes.textField}
            required
            error={!!validationErrors['header.name']}
            helperText={validationErrors['header.name'] || ''}
          />
        </Box>
        <Box className={classes.fieldContainer}>
          <TextField
            ...
            required
            placeholder="e.g., 9999955555"
            error={!!validationErrors['header.phone']}
            helperText={validationErrors['header.phone'] || ''}
          />
        </Box>
      </Box>
      ...
      <Box className={classes.fieldRow}>
        <Box className={classes.fieldContainer}>
          <TextField
            ...
            className={classes.textField}
            required
            error={!!validationErrors['header.email']}
            helperText={validationErrors['header.email'] || ''}
          />
        </Box>
        <Box className={classes.fieldContainer}>
          {/* Target Role with Autocomplete using cached data */}
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                ...
                className={classes.textField}
                placeholder="e.g., Front-end Developer"
                error={!!validationErrors['target_role'] || !!error}
                helperText={validationErrors['target_role'] || error || "Select your target job role"}
                InputProps={{
                  ...params.InputProps,
                  endAdornment: (
                    <>
